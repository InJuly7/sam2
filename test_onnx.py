...
def main():
    ...
    img_path = "/home/linaro/program/sam2/dog.jpg"
    orig_image, input_image, (scale, offset_x, offset_y) = load_image(img_path)
    ...
    encoder_path = "/data/model/sam2/image_encoder_s.onnx"
    decoder_path = "/data/model/sam2/image_decoder_s.onnx"
    ...
    plt.subplot(121)
    plt.imshow(orig_image)
    plt.title('Original Image')  # Add title for clarity
    plt.axis('off')
