...
if __name__ == "__main__":
    ...
    # /data/model/sam2/sam2.1_hiera_small.pt
    args.model_type = "sam2.1_hiera_small"
    args.checkpoint = "/model/sam2/sam2.1_hiera_small.pt"
    args.output_encoder = "./image_encoder_s.onnx"
    args.output_decoder = "./image_decoder_s.onnx"
    args.opset = 17
